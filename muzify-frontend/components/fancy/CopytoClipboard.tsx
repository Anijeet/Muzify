  ...
  return (
      <div className="relative">
        <button 
          ...
          className="flex items-center gap-2 text-sm text-gray-400 z-50 px-4 py-2 rounded-md transition-all hover:border ease-in-out duration-200 border-0 border-gray-700"
        >
        ...
        <AnimatePresence>
          {copied && (
            ...
            >
              <span className="text-gray-300 font-black px-2 py-1 rounded-sm text-sm">
                Copied!
              </span>
            </motion.div>
          )}
