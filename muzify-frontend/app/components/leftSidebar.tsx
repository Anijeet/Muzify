...
const handleSearch = async () => {
  ...
  return (
    <div className="w-full md:w-[40vw] lg:w-[23vw] h-full py-3 px-2 md:pt-5 md:px-3">
      <div className="w-full bg-slate-800 py-4 rounded-2xl flex flex-col h-full overflow-y-auto px-4">
        <div className="flex md:flex-col items-center">
          <h1 className="font-funnel text-gray-300 text-3xl md:text-4xl text-center pb-3 md:pt-8 md:pb-4 font-semibold">
            Muzify
          </h1>
        ...
        <div className="flex flex-col gap-2">
          <span className="text-sm text-white font-semibold font-funnel">Total Users: <span className="font-funnel text-base text-blue-600">{userCount}</span></span>
