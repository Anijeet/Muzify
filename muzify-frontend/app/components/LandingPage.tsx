...
const LandingPage = () => {
    ...
    const elements = [
        ...
        { 
            ...
            image: "/tuki.jpg",
            alt: "tuki",
            song: "/audio/KASTOCHATIMILAI.mp3", 
         },
        { 
            top: "top-[35rem]", 
            right: "right-[28rem]", 
  ...
  return (
    ...
    <div className="w-fit h-fit font-funnel flex items-center justify-center leading-none text-[12vw] sm:text-[9vw] lg:text-[7vw] text-white">
      ...
      <motion.span 
        initial={{ scale: 0 }} 
        animate={{ scale: 1 }} 
        className="p-6 border-2 rounded-full mt-4 md:mt-6 sm:block"
      > 
        <Image width={60} height={120} src="/Z.png" alt="Muzify Logo" />
       </motion.span>
    ...
    <motion.div 
            ...
            >
                <div className="w-full h-full flex flex-col md:flex-row justify-between items-center px-6 md:px-16 py-6 md:py-8 bg-[#b3b3b3] rounded-2xl text-center md:text-left">
                    ...
                    <Link
                        href="https://x.com/Anijitmani_18"
